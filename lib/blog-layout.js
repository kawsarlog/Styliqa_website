...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-EF1ZJYMNER"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-EF1ZJYMNER');
</script>
...
<header class="nav" id="nav">
  <div class="nav__inner">
    ...
    <a href="https://calendly.com/adnanmojid/30min" target="_blank" rel="noopener" class="btn btn--brand btn--sm nav__cta">Book a Consultation</a>
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <a href="/blog">Blog</a>
    <a href="/#contact">Contact</a>
    <a href="https://calendly.com/adnanmojid/30min" target="_blank" rel="noopener" class="btn btn--brand btn--sm">Book a Consultation</a>
  </div>
</header>
